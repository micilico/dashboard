...
- `GET /api/v1/search` pour rechercher des releases
- `POST /api/v1/download` pour demander a Prowlarr d'envoyer la release au client configure
...
- l'envoi vers qBittorrent utilise l'action native de telechargement Prowlarr; aucun lien de telechargement prive n'est renvoye au navigateur
