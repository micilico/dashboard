...
MEDIA_ORGANIZER_URL = os.getenv("TORRENT_PANEL_MEDIA_ORGANIZER_URL", "http://127.0.0.1:3130/api/files/organize/apply").strip()
MEDIA_ORGANIZER_TOKEN = os.getenv("TORRENT_PANEL_MEDIA_ORGANIZER_TOKEN", "")
