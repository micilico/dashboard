...
async function openOrganizeMediaDialog() {
  ...
  try {
    ...
    els.confirmOrganizeMediaButton.disabled = entries.length === 0;
...
async function confirmOrganizeMedia() {
  ...
  try {
    ...
    showToast(`Rangement : ${parts.join(", ")}. Les torrents restent en pause jusqu’à leur vérification à 100 %.`);
